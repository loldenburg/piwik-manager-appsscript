...
function showTerms(showSetupInfo) { // TODO
    ...
    <h3 style="font-family: Calibri,sans-serif">See the <a href="https://github.com/loldenburg/piwik-manager-appsscript/blob/main/terms_and_conditions.md" target="_blank">terms & conditions</a> for the free trial version and our <a href="https://github.com/loldenburg/piwik-manager-appsscript/blob/main/data_protection_info.md" target="_blank">data protection info</a>.</h3>
    ` + setupInfoText + `
...
function guidedSetup() {
    ...
    if (response3.getSelectedButton() === ui.Button.OK) {
        ...
        if (response3.getResponseText()) {
            secret = response3.getResponseText() || secret;
